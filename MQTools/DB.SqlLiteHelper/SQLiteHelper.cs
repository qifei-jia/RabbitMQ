...
namespace System.Data.My.SQLite
{
    ...
    public class SQLiteHelper
    {
        ...
        /// <param name="Where"> a='123'</param>
        public void DeleteTable(string table, string Where = "")
        {
            cmd.CommandText = string.Format("DELETE FROM {0} {1}", table, string.IsNullOrEmpty(Where) ? "" : " where " + Where);
            cmd.ExecuteNonQuery();
        }
